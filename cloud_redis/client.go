...
type Redis interface {
	...
	WithRetryableDistributedLock(ctx context.Context, key string, fn func() (interface{}, error), timeout, retryPeriod time.Duration, ttl ...time.Duration) (interface{}, error)
	WithDistributedLock(ctx context.Context, key string, fn func() (interface{}, error), ttl ...time.Duration) (interface{}, error)
}
